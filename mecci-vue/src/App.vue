  ...
  <v-app>
    ...
    <v-container  v-if = "render == 0" class="text-center mt-15">
        <v-row>
          ...
          <v-col cols="12" sm="2">
            <v-btn class = "ma-5 mt-10" color="green-lighten-2" v-on:click="getData" min-height="100" min-width="200">{{ proceed }}</v-btn>
            <v-btn class = "ma-5" color="red-lighten-1" min-height="100" min-width="200" @click = "render = 1">Show Diff</v-btn>
            <v-btn class = "ma-5" color="blue-darken-2" min-height="100" min-width="200" @click = "render = 2">Show Graph</v-btn>
          </v-col>
        </v-row>
    </v-container>
  </v-app>
